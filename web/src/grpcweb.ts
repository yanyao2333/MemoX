...
export const workspaceSettingServiceClient = clientFactory.create(
...
export const resourceServiceClient = clientFactory.create(
...
export const activityServiceClient = clientFactory.create(
  ActivityServiceDefinition,
  channel
);

export const webhookServiceClient = clientFactory.create(
  WebhookServiceDefinition,
  channel
);

export const markdownServiceClient = clientFactory.create(
  MarkdownServiceDefinition,
  channel
);

export const identityProviderServiceClient = clientFactory.create(
